...
This module for Testerra framework allows to synchronize the test results to the test management tool MicroFocus ALM/Quality Center (formaly known as HP Quality Center).
